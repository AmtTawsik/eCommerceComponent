    ...
    <div class="bg-white">
        <div>
                                        ...
                                        <h3 class="-mx-2 -my-3 flow-root">
                                            <DisclosureButton
                                                ...
                                                <span class="ml-6 flex items-center">
                                                    <UIcon name="i-heroicons-plus" v-if="!open" class="h-5 w-5"
                                                        aria-hidden="true" />
                                                    <UIcon name="i-heroicons-minus" v-else class="h-5 w-5"
                                                        aria-hidden="true" />
                                                </span>
                                            </DisclosureButton>
                                        </h3>
            ...
            <main class="mx-auto w-11/12">
                <div class="flex items-baseline justify-between border-b border-gray-200 pb-5">
                ...
                option.name }}</a>
                        ...
                        <button type="button" class="-m-2 ml-5 p-2 text-gray-400 hover:text-gray-500 sm:ml-7">
                            ...
                            <UIcon name="i-heroicons-squares-2x2" class="h-5 w-5" aria-hidden="true" />
                        </button>
                        <button type="button" class="-m-2 ml-4 p-2 text-gray-400 hover:text-gray-500 sm:ml-6 lg:hidden"
                            @click="mobileFiltersOpen = true">
                            <span class="sr-only">Filters</span>
                            <UIcon name="i-heroicons-funnel" class="h-5 w-5" aria-hidden="true" />
                        </button>
                    </div>
                </div>
                                ...
                                <h3 class="-my-3 flow-root">
                                    <DisclosureButton
                                        ...
                                        <span class="ml-6 flex items-center">
                                            <UIcon name="i-heroicons-plus" v-if="!open" class="h-5 w-5"
                                                aria-hidden="true" />
                                            <UIcon name="i-heroicons-minus" v-else class="h-5 w-5" aria-hidden="true" />
                                        </span>
                                    </DisclosureButton>
                                </h3>
                                <DisclosurePanel class="pt-6">
