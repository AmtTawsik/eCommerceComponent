<template>
    <div class="bg-white">
      ...
      <header class="relative bg-white">
        ...
        <nav aria-label="Top" class="mx-auto w-11/12">
          <div class="border-b border-gray-200">
            <div class="flex h-16 items-center">
              ...
              <!-- Flyout menus -->
              <PopoverGroup class="hidden lg:ml-[40%] lg:block lg:self-stretch">
              ...
              <div class="ml-auto flex items-center">
                <div class="hidden lg:flex fixed top-1.5 right-5 lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  <a href="#" class="text-sm font-medium text-gray-50 hover:text-white">Sign in</a>
                  <span class="h-6 w-px bg-gray-200" aria-hidden="true" />
                  <a href="#" class="text-sm font-medium text-gray-50 hover:text-white">Create account</a>
                </div>
                ...
                <!-- Search -->
                <div class="flex lg:ml-6 md:-mb-2 -mb-1.5">
                  <a href="#" class="p-2 text-gray-400 hover:text-gray-500">
                    <span class="sr-only">Search</span>
                    <UIcon name="i-heroicons-magnifying-glass" class="h-6 w-6" aria-hidden="true" />
                  </a>
                </div>
                ...
                <div class="ml-4 flow-root lg:ml-6">
                  <a href="#" class="group -m-2 flex items-center p-2">
                    <UIcon name="i-heroicons-shopping-bag" class="h-6 w-6 flex-shrink-0 text-gray-400 group-hover:text-gray-500" aria-hidden="true" />
